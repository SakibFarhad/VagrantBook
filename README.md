...
This is my VM automation book. I like to use `vagrant` on `libvirt` with `kvm/qemu` provider
...
# vagrant plugin install vagrant-libvirt vagrant-timezone
